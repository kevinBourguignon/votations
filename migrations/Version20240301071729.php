 ...
 */
final class Version20240301071729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sessions_candidat (id INT AUTO_INCREMENT NOT NULL, candidat_id INT NOT NULL, INDEX IDX_52F657458D0EB82 (candidat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
